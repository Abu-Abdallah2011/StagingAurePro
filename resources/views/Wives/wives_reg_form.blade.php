        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
                    ...
                    <section>
                        ...
                        <form method="POST" action="{{ url('wives_reg_form') }}" enctype="multipart/form-data">
                            @csrf
                        ...
                        <div>
                           ...
                           <div>
                            ...
                            <x-text-input id="email" class="block mt-1 w-full" type="text" placeholder="Input Wife Email if Any" name="email" :value="old('email')" required autofocus autocomplete="email" />
